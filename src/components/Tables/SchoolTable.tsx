      ...
      <table className="w-full table-auto">
        <thead>
          <tr className="bg-[#F7F9FC] text-left dark:bg-dark-2">
            <th className="font-medium text-dark dark:text-white xl:pl-7.5">
              #
            </th>
                ...
                >
                  <p className="text-dark dark:text-white">
                    <ul>
                      ...
                      {school?.pageUrl && <li><a href={school?.pageUrl} className="text-blue-700 hover:underline" target="BLANK_">{school?.pageUrl}</a></li>}
                    </ul>
                  </p>
                </td>
                <td
