...
const SelectGender: React.FC<SelectGenderProps> = ({ setState, gender }) => {
    ...
    <div className="mb-4.5">
      ...
      <div className="relative z-20 bg-transparent dark:bg-dark-2">
        ...
        >
          ...
          <option value="M" className="text-dark-6">
            Male
          </option>
          <option value="F" className="text-dark-6">
            Female
          </option>
          <option value="O" className="text-dark-6">
            Other
          </option>
        </select>
